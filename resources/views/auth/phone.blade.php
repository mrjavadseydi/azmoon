...
<div class="login-wrap">
    <div class="login-html">
        <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab"
                                                                                 style="font-family: Vazir">کد تایید پیامک شده  را وارد کنید </label>
        <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"
                                                                         style="display: none;">ثبت نام</label>
        <div class="login-form">
            <div class="sign-in-htm">
                <form method="post" action="{{route('signup')}}">
                    ...
                    @method('put')
                    <div class="group">
                        <label for="user" class="label">کد تایید</label>
                        <input id="user" type="text" name="code" class="input">
                    </div>
                    <div class="group">
                        <input type="submit" class="button" value="تایید تلفن همراه">
                    </div>
                    <div class="hr"></div>
                </form>
            </div>
